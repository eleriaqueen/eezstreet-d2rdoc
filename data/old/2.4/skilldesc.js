...
files["skilldesc"] = {
    ...
    "fields": [
        ...
        },
        {
            ...
            "description": "Determines the icon asset for displaying the skill, using the Frame# of the Sprite (See Common Folders). There is no \"when pressed\" icon visual. The sprite path can be changed in _ProfileHD.json or _ProfileLV.json",
            "type": {
                "type": "int",
                "dataLength": 0,
                "memSize": 0
