...
files["itemstatcost"] = {
    ...
    "overview": "Thisfile controls the functionalities for each possible stat on a unit<br>Thesedefined stats are used to form modifiers for the Properties.txt file<br>Anycolumn field name starting with \"*\" is considered a comment field and is notused by the game",
    "fields": [
        {
            "name": "Stat",
        ...
        {
            "name": "Signed",
            "description": "If equals 1, then the stat will be treated as a signed integer, meaning that it can be either a positive or negative value. If equals 0, then stat will be treated as an unsigned integer, meaning that it can only be a positive value. This only affects stats with state bits",
            "type": {
                "type": "bool",
                "dataLength": 0,
                "memSize": 0
        ...
        {
            "name": "UpdateAnimRate",
            "description": "If equals 1, then the stat will notify that game to handle and adjust the speed of the unit when the stat changes. If equals 0, then ignore this. This is only checked for stats with States or for specific skill server functions including 30, 61, 71",
            "type": {
                "type": "bool",
                "dataLength": 0,
                "memSize": 0
        ...
        {
            "name": "Saved",
            "description": "If equals 1, then this state will be inserted in the change list to be stored in the Character Save file. If equals 0, then ignore this",
            "type": {
                "type": "bool",
                "dataLength": 0,
                "memSize": 0
        ...
        {
            "name": "CSvSigned",
            "description": "If equals 1, then the stat will be saved as a signed integer in the Character Save file. If equals 0, then the stat will be saved as an unsigned integer in the Character Save file. This is only used if the \"Saved\" field is enabled",
            "type": {
                "type": "bool",
                "dataLength": 0,
                "memSize": 0
        ...
        {
            "name": "fCallback",
            "description": "If equals 1, then any changes to the stat will call the Callback function which will update thgecharacter's States, skills, or item events based on the changed stat value. If equals 0, then ignore this",
            "type": {
                "type": "bool",
                "dataLength": 0,
                "memSize": 0
        ...
        {
            "name": "fMin",
            "description": "If equals 1, then the stat will have a minimum value that cannot be reduced further than that value (\"MinAccr\" field). If equals 0, then ignore this",
            "type": {
                "type": "bool",
                "dataLength": 0,
                "memSize": 0
        ...
        },
        {
            ...
            "description": "Controls how many bits of data for the stat's parameter value to use when saving/reading an item from a Character Save. This value is always treated asan unsigned integer",
            "type": {
                "type": "int",
                "dataLength": 0,
                "memSize": 0
        ...
        {
            "name": "keepzero",
            "description": "If equals 1, then this stat will remain on the stat change list, when being updated, even if that stat value is 0. If equals 0, then ignore this",
            "type": {
                "type": "bool",
                "dataLength": 0,
                "memSize": 0
        ...
        {
            "name": "damagerelated",
            "description": "If equals 1, then this stat will be exclusive to the item and will not add to the unit. If equals 0, then ignore this, and the stat will always add to the unit. This is typically used for weapons and is important when dual wielding weapons so that when a unit attacks, then one weapon's stats do not stack with another weapon's stats",
            "type": {
                "type": "bool",
                "dataLength": 0,
                "memSize": 0
        ...
        {
            "name": "descfunc",
            "description": "Controls how the stat is displayed in tooltips. Uses the Code value from the below table to format the string value using the specified function",
            "type": {
                "type": "int",
                "dataLength": 0,
                "memSize": 0
        ...
        {
            "name": "dgrp",
            "description": "Assigns the stat to a group ID value. If all stats with a matching \"dgrp\" value are applied on the unit, then instead of displaying each stat individually, the group description will be applied instead (dgrpfunc field below)",
            "type": {
                "type": "int",
                "dataLength": 0,
                "memSize": 0
        ...
        {
            "name": "dgrpfunc",
            "description": "Controls how the shared group of stats is displayed in tooltips. Uses an ID value to select a description function to format the string value. This function IDs are exactly the same as the descfunc field",
            "type": {
                "type": "int",
                "dataLength": 0,
                "memSize": 0
