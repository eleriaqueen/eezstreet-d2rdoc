...
files["automagic"] = {
    ...
    "fields": [
        ...
        {
            "name": "version",
            "description": "Defines which game version to use this item affix (0 = Classic mode | 100 = Expansion mode)",
            "type": {
                "type": "int",
                "dataLength": 0,
                "memSize": 0
        ...
        {
            "name": "classspecific",
            "description": "Controls if this item affix should only be used for class specific items. Specified by the Code column in PlayerClass.txt",
            "type": {
                "type": "string",
                "dataLength": 0,
                "memSize": 0
        ...
        {
            "name": "class",
            "description": "Controls which character class is required for the class specific level requirement specified in the below classlevelreq field. Specified by the Code column in PlayerClass.txt",
            "type": {
                "type": "string",
                "dataLength": 0,
                "memSize": 0
        ...
        {
            "name": "classlevelreq",
            "description": "The minimum character level required for a specific class in order to equip an item that has this item affix. This relies on the class specified in the above class field. If equals null, then the class will default to using the levelreq field",
            "type": {
                "type": "int",
                "dataLength": 0,
                "memSize": 0
        ...
        },
        {
            ...
            "description": "Controls the item properties for the item affix using the Code value from Properties.txt",
            "type": {
                "type": "string",
                "dataLength": 0,
                "memSize": 0
