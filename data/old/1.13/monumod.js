...
files["monumod"] = {
    "title": "monumod.txt",
    "overview": "This file controls the different monster modifiers for special monsters, including Unique and Champion monsters<br>Any column field name starting with \"*\" is considered a comment field and is not used by the game<br>The \"(N)\" text in field names signifies to use that specific value for games in Nightmare difficulty<br>The \"(H)\" text in field names signifies to use that specific value for games in Hell difficulty",
    "fields": [
        {
            "name": "uniquemod",
        ...
        {
            "name": "enabled",
            "description": "If equals 1, then this monster modifier will be an available option for monsters to spawn with. If equals 0, then this monster modifier will never be used",
            "type": {
                "type": "bool",
                "dataLength": 0,
                "memSize": 0
        ...
        {
            "name": "xfer",
            "description": "If equals 1, then this monster modifier can be transferred from the Boss monster to his Minion monsters, including auras. If equals 0, then the monster modifier will never be transferred",
            "type": {
                "type": "bool",
                "dataLength": 0,
                "memSize": 0
        ...
        {
            "name": "champion",
            "description": "If equals 1, then this monster modifier will only be used by Champion monsters. If equals 0, then the monster modifier can be used by any type of special monster",
            "type": {
                "type": "bool",
                "dataLength": 0,
                "memSize": 0
