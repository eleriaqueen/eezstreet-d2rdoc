...
files["monseq"] = {
    "title": "monseq.txt",
    "overview": "This file controls the sequence table used for specifying events during certain animation frames, such as when using skills.<br>A sequence is divided into multiple lines in this file to define each frame in the animation and to determine which event to use during a specific frame.",
    "fields": [
        {
            "name": "sequence",
